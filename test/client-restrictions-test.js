...
describe("SOAP Client", function () {
  describe("with enforce restrictions option as true", function () {
    ...
    it("should NOT throw if the values don't match the restrictions", function (done) {
      soap.createClient(
        __dirname + "/wsdl/restrictions.wsdl",
      ...
      soap.createClient(
        ...
        function (err, client) {
          ...
          try {
            ...
            assert.equal(
              err.message,
              'The field MinExclusiveType cannot have value 5 due to the violations: ["value is less or equal than minExclusive (5 <= 5)"]'
            );
            done();
          }
        },
      ...
      soap.createClient(
        ...
        function (err, client) {
          ...
          try {
            ...
            assert.equal(
              err.message,
              'The field MinExclusiveType cannot have value five due to the violations: ["value is not a number (five)"]'
            );
            done();
          }
        },
      ...
      soap.createClient(
        ...
        function (err, client) {
          ...
          try {
            ...
            assert.equal(
              err.message,
              'The field MinInclusiveType cannot have value 4 due to the violations: ["value is less than minInclusive (4 < 5)"]'
            );
            done();
          }
        },
      ...
      soap.createClient(
        ...
        function (err, client) {
          ...
          try {
            ...
            assert.equal(
              err.message,
              'The field MaxExclusiveType cannot have value 5 due to the violations: ["value is greater or equal than maxExclusive (5 >= 5)"]'
            );
            done();
          }
        },
      ...
      soap.createClient(
        ...
        function (err, client) {
          ...
          try {
            ...
            assert.equal(
              err.message,
              'The field MaxInclusiveType cannot have value 6 due to the violations: ["value is greater than maxInclusive (6 > 5)"]'
            );
            done();
          }
        },
      ...
      soap.createClient(
        ...
        function (err, client) {
          ...
          try {
            ...
            assert.equal(
              err.message,
              'The field FractionDigitsType cannot have value 12.123 due to the violations: ["value has more decimal places than allowed (3 > 1)"]'
            );
            done();
          }
        },
      ...
      soap.createClient(
        ...
        function (err, client) {
          ...
          try {
            ...
            assert.equal(
              err.message,
              'The field TotalDigitsType cannot have value 12345 due to the violations: ["value has more digits than allowed (5 > 4)"]'
            );
            done();
          }
        },
      ...
      soap.createClient(
        ...
        function (err, client) {
          ...
          try {
            ...
            assert.equal(
              err.message,
              'The field TotalDigitsType cannot have value 12345 due to the violations: ["value has more integer digits than allowed (5 > 4)"]'
            );
            done();
          }
        },
      ...
      soap.createClient(
        ...
        function (err, client) {
          ...
          try {
            ...
            assert.equal(
              err.message,
              'The field TotalDigitsType cannot have value 1234.2 due to the violations: ["value has more digits than allowed (5 > 4)"]'
            );
            done();
          }
        },
      ...
      soap.createClient(
        ...
        function (err, client) {
          ...
          try {
            ...
            assert.equal(
              err.message,
              'The field LengthType cannot have value 123456 due to the violations: ["lengths don\'t match (6 != 5)"]'
            );
            done();
          }
        },
      ...
      soap.createClient(
        ...
        function (err, client) {
          ...
          try {
            ...
            assert.equal(
              err.message,
              'The field LengthType cannot have value 1234 due to the violations: ["lengths don\'t match (4 != 5)"]'
            );
            done();
          }
        },
      ...
      soap.createClient(
        ...
        function (err, client) {
          ...
          try {
            ...
            assert.equal(
              err.message,
              'The field MaxLengthType cannot have value abcdef due to the violations: ["length is bigger than maxLength (6 > 5)"]'
            );
            done();
          }
        },
      ...
      soap.createClient(
        ...
        function (err, client) {
          ...
          try {
            ...
            assert.equal(
              err.message,
              'The field MinLengthType cannot have value ab due to the violations: ["length is smaller than minLength (2 < 4)"]'
            );
            done();
          }
        },
      ...
      soap.createClient(
        ...
        function (err, client) {
          ...
          try {
            ...
            assert.equal(
              err.message,
              'The field PatternType cannot have value abcdef due to the violations: ["value doesn\'t match the required pattern (abcdef !match [0-9]{8})"]'
            );
            done();
          }
        },
      ...
      soap.createClient(
        ...
        function (err, client) {
          ...
          try {
            ...
            assert.equal(
              err.message,
              'The field EnumerationType cannot have value InvalidValue due to the violations: ["value is not in the list of valid values (InvalidValue is not in validValue1,validValue2)"]'
            );
            done();
          }
        },
    ...
    it("should throw if the maxLength doesn't match its restriction in an anonymous simple type", function (done) {
      soap.createClient(
        __dirname + "/wsdl/restriction_anonymous_types.wsdl",
        { enforceRestrictions: true },
        function (err, client) {
          assert.equal(err, null);
          try {
            ...
            assert.equal(
              err.message,
              'The field elementWithAnonymousType cannot have value abcdef due to the violations: ["length is bigger than maxLength (6 > 3)"]'
            );
            done();
          }
        },
