      ...
      soap.createClient(
        ...
        function (err, client) {
          ...
          client.GetLastTradePrice(
            { TradePriceRequest: { tickerSymbol: "ACME" } },
    ...
    test.server.listen(15099, null, null, function () {
      ...
      soap.createClient(
        ...
        function (err, client) {
          assert.ok(!err);
          client.GetLastTradePrice(
            { TradePriceRequest: { tickerSymbol: "xml response" } },
            function (err, response, body) {
              assert.ok(!err);
              assert.strictEqual(body, responseData);
              done();
